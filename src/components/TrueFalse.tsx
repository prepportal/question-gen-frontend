...
const TrueFalse = ({game}: Props) => {
    ...
    const [selectedOption, setSelectedOption] = useState<number>(0);       //all the options bg are black , we need to know which option has been selected inorder to differentiate it from the rest , just like we did in mcq and fib button in the quiz form , changing the bg on the button which is clicked
          ...
          return (
            ...
            >
              <div className="flex items-center justify-start">
                ...
                <div className="text-start">{option.toUpperCase()}</div>
              </div>
            </Button>
          );
        })}
